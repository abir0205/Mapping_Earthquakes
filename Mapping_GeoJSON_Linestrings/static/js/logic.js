...
//       console.log(feature);
//       return L.marker(latlng).bindPopup("<h2>" + feature.properties.name + " " + feature.properties.city + ", " + feature.properties.country + "</h2>");
//     }
//
//   }).addTo(map);
...
let torontoData = "https://raw.githubusercontent.com/abir0205/Mapping_Earthquakes/main/torontoRoutes.json";
